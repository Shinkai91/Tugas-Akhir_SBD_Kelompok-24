...
<body style="height:100%">
    <nav class="navbar navbar-light sticky-top justify-content-between" id="navbar">
        ...
        <form class="form-inline">
            ...
            <a class="nav-link" href="/user/cart" style="font-size: 20px; color: #3C4858; margin-right: 15px">Keranjang</a>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6" data-aos="fade-right" data-aos-duration="3000">
                    ...
                    <p class="para-desc text-muted">
                        Dapatkan penampilan terbaik Anda dengan koleksi fashion terbaru di toko baju kami. Kami
                        menyediakan
                        pilihan
                        ...
                        Kualitas dan gaya tidak pernah kompromi - kami menawarkan produk berkualitas tinggi yang
                        dirancang
                        untuk
                        memberikan kepercayaan diri maksimal kepada pelanggan kami.
                        Jelajahi katalog kami sekarang dan temukan pakaian yang cocok untuk setiap suasana, dari gaya
                        kasual
                        hingga
                ...
                <div class="col-lg-6" data-aos="fade-left" data-aos-duration="3000">
                    <div class="text-md-right text-center"><img src="{{ asset('images/atl-2-c.png') }}"
                            class="img-fluid" style="width:70%"></div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="col-lg-12 text-center">
                    ...
                    <p class="text-muted para-desc mx-auto mb-4" data-aos="fade-down" data-aos-duration="2000">
                        ...
                        <a class="text-primary font-weight-bold" href="#">Store Baju</a></span>.
                    </p>
                </div>
                <div class="card-deck">
                    ...
                    <div class="card" data-aos="fade-left" data-aos-duration="3000">
                        <img class="card-img-top" src="{{ asset('images/product/baju-3.jpg') }}"
                            alt="Card image cap">
                        <div class="card-body">
                            <h5 class="card-title">Makoto Shinkai Short Sleeve UT</h5>
                            <p class="card-text">Limited-edition Uniqlo t-shirts (UTs) will be based on the worlds of
